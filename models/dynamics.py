...
# this script was adapted from the DGL implementation of EGNN
# original script: https://github.com/dmlc/dgl/blob/76bb54044eb387e9e3009bc169e93d66aa004a74/python/dgl/nn/pytorch/conv/egnnconv.py
# I have extended this model to operate on heterogeneous graphs
# containg receptor keypoints and ligand atoms


class ComplexEGNNConv(nn.Module):
    ...
    def forward(self, graph, node_feat, coord_feat, edge_feat=None):
        ...
        with graph.local_scope():
            ...
            # compute messages along every edge
            graph.apply_edges(self.message)

            # aggregate messages for both coordinates and features
            graph.update_all(fn.copy_e("msg_x", "m"), fn.mean("m", "x_neigh"))
            graph.update_all(fn.copy_e("msg_h", "m"), fn.sum("m", "h_neigh"))

            h_neigh, x_neigh = graph.ndata["h_neigh"], graph.ndata["x_neigh"]

            # compute updated coordinates and features
