...
class ReceptorEncoder(nn.Module):
    ...
    def forward(self, rec_graph: dgl.DGLGraph):
        node_positions = rec_graph.ndata['x']
        node_features = rec_graph.ndata['h']

        # TODO: egnn conv does everything with a local scope. is this inefficient? does it cause problems with backprop?
